import{_ as p,C as c,o as E,c as t,H as n,w as e,k as s,a as l}from"./chunks/framework.3e3201d2.js";const H=JSON.parse('{"title":"Tree 树形控件","description":"","frontmatter":{},"headers":[],"relativePath":"vant/tree.md","filePath":"vant/tree.md","lastUpdated":1681352261000}'),r={name:"vant/tree.md"},y=s("h1",{id:"tree-树形控件",tabindex:"-1"},[l("Tree 树形控件 "),s("a",{class:"header-anchor",href:"#tree-树形控件","aria-label":'Permalink to "Tree 树形控件"'},"​")],-1),i=s("h2",{id:"基础使用",tabindex:"-1"},[l("基础使用 "),s("a",{class:"header-anchor",href:"#基础使用","aria-label":'Permalink to "基础使用"'},"​")],-1),F=s("div",{class:"language-vue vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`

...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"<"),s("span",{style:{color:"#22863A"}},"style"),s("span",{style:{color:"#24292E"}}," "),s("span",{style:{color:"#6F42C1"}},"lang"),s("span",{style:{color:"#24292E"}},"="),s("span",{style:{color:"#032F62"}},'"scss"'),s("span",{style:{color:"#24292E"}},">")]),l(`
`),s("span",{class:"line"}),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"style"),s("span",{style:{color:"#24292E"}},">")])])])],-1),h=s("h2",{id:"picker-属性",tabindex:"-1"},[l("Picker 属性 "),s("a",{class:"header-anchor",href:"#picker-属性","aria-label":'Permalink to "Picker 属性"'},"​")],-1),f=r('<h2 id="tablecolumn-属性" tabindex="-1">TableColumn 属性 <a class="header-anchor" href="#tablecolumn-属性" aria-label="Permalink to &quot;TableColumn 属性&quot;">​</a></h2><p><a href="./table-batch">查看TableColumn属性</a></p><h2 id="picker-slots" tabindex="-1">Picker slots <a class="header-anchor" href="#picker-slots" aria-label="Permalink to &quot;Picker slots&quot;">​</a></h2>',3),S=s("h2",{id:"picker-expose",tabindex:"-1"},[l("Picker Expose "),s("a",{class:"header-anchor",href:"#picker-expose","aria-label":'Permalink to "Picker Expose"'},"​")],-1);function x(H,_,N,w,G,L){const n=c("demo"),e=c("v-table");return t(),E("div",null,[i,F,o(n,{md:"",src:"picker/basic"},{default:a(()=>[d]),_:1}),C,o(n,{md:"",src:"picker/slots"},{default:a(()=>[B]),_:1}),m,o(n,{md:"",src:"picker/custom-right"},{default:a(()=>[u]),_:1}),A,D,o(n,{md:"",src:"picker/dialog"},{default:a(()=>[k]),_:1}),g,b,o(n,{md:"",src:"picker/show-count"},{default:a(()=>[v]),_:1}),h,o(e,{type:"attrs",data:[{attr:"modelValue / v-model",dec:"勾选的列表",type:"array",optional:"-",default:[]},{attr:"table-column",dec:"表格列表",type:"array",optional:"-",default:"[]"},{attr:"table-data",dec:"表格数据",type:"array",optional:"-",default:"[]"},{attr:"select-list",dec:"设置选中的数组",type:"array",optional:"-",default:[]},{attr:"key-id",dec:"设置选择的唯一值",type:"string",optional:"-",default:"id"},{attr:"key-name",dec:"设置选择的名字参数",type:"string",optional:"-",default:"name"},{attr:"scrollbar-always-on",dec:"总是显示滚动条",type:"string",optional:"-",default:"false"},{attr:"height",dec:"表格的高度,如果自适应布局,设置100%",type:"string",optional:"-",default:"442px"},{attr:"right-width",dec:"右侧的固定宽度，如果没有设置15:9",type:"string",optional:"-",default:""}]}),f,o(e,{type:"slot",data:[{name:"header",dec:"自定义表头插槽",child:"{  column }"},{name:"custom",dec:"自定义内容插槽",child:"{ row, column, index }"},{name:"right",dec:"右侧插槽",child:"-"},{name:"right-header",dec:"右侧表头插槽",child:"-"}]}),S,o(e,{type:"slot",data:[{name:"resetData",dec:"清空以及重置数据",child:"-"},{name:"deleteHandler",dec:"删除选中的某一个",child:"row"}]})])}const M=p(y,[["render",x]]);export{T as __pageData,M as default};

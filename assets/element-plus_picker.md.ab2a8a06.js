...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"<"),s("span",{style:{color:"#22863A"}},"style"),s("span",{style:{color:"#24292E"}}," "),s("span",{style:{color:"#6F42C1"}},"lang"),s("span",{style:{color:"#24292E"}},"="),s("span",{style:{color:"#032F62"}},'"scss"'),s("span",{style:{color:"#24292E"}},">")]),l(`
`),s("span",{class:"line"}),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"style"),s("span",{style:{color:"#24292E"}},">")])])])],-1),h=s("h2",{id:"picker-属性",tabindex:"-1"},[l("Picker 属性 "),s("a",{class:"header-anchor",href:"#picker-属性","aria-label":'Permalink to "Picker 属性"'},"​")],-1),g=r('<h2 id="tablecolumn-属性" tabindex="-1">TableColumn 属性 <a class="header-anchor" href="#tablecolumn-属性" aria-label="Permalink to &quot;TableColumn 属性&quot;">​</a></h2><p><a href="./table-batch">查看TableColumn属性</a></p><h2 id="picker-slots" tabindex="-1">Picker slots <a class="header-anchor" href="#picker-slots" aria-label="Permalink to &quot;Picker slots&quot;">​</a></h2>',3);function v(f,S,_,P,w,N){const n=c("demo"),e=c("v-table");return t(),E("div",null,[i,F,o(n,{md:"",src:"picker/basic"},{default:a(()=>[d]),_:1}),C,o(n,{md:"",src:"picker/slots"},{default:a(()=>[m]),_:1}),B,u,o(n,{md:"",src:"picker/dialog"},{default:a(()=>[A]),_:1}),k,D,o(n,{md:"",src:"picker/show-count"},{default:a(()=>[b]),_:1}),h,o(e,{type:"attrs",data:[{attr:"modelValue / v-model",dec:"勾选的列表",type:"array",optional:"-",default:[]},{attr:"table-column",dec:"表格列表",type:"array",optional:"-",default:"[]"},{attr:"table-data",dec:"表格数据",type:"array",optional:"-",default:"[]"},{attr:"select-list",dec:"设置选中的数组",type:"array",optional:"-",default:[]},{attr:"key-id",dec:"设置选择的唯一值",type:"string",optional:"-",default:"id"},{attr:"key-name",dec:"设置选择的名字参数",type:"string",optional:"-",default:"name"}]}),g,o(e,{type:"slot",data:[{name:"header",dec:"自定义表头插槽",child:"{  column }"},{name:"custom",dec:"自定义内容插槽",child:"{ row, column, index }"},{name:"right",dec:"右侧插槽",child:"-"},{name:"right-header",dec:"右侧表头插槽",child:"-"}]})])}const G=p(y,[["render",v]]);export{x as __pageData,G as default};

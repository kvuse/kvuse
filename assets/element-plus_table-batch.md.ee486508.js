import{_ as t,C as c,o as p,c as E,H as o,w as e,Q as r,k as s,a as l}from"./chunks/framework.6c428c33.js";const $=JSON.parse('{"title":"BatchTable 批量表格","description":"","frontmatter":{},"headers":[],"relativePath":"element-plus/table-batch.md","filePath":"element-plus/table-batch.md","lastUpdated":1694077054000}'),y={name:"element-plus/table-batch.md"},i=r('<h1 id="batchtable-批量表格" tabindex="-1">BatchTable 批量表格 <a class="header-anchor" href="#batchtable-批量表格" aria-label="Permalink to &quot;BatchTable 批量表格&quot;">​</a></h1><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>表格带有分页，如果设置<code>total</code>大于10，会显示分页，如果只有一页数据，分页不显示</p><p><strong>批量表格，带有多选框，如果使用一般的表格，建议使用<a href="./table">Table 表格</a></strong></p></div><h2 id="基础使用" tabindex="-1">基础使用 <a class="header-anchor" href="#基础使用" aria-label="Permalink to &quot;基础使用&quot;">​</a></h2><p>可以设置<code>key-id</code>设置唯一标识，默认为id</p>',4),F=s("div",{class:"language-vue vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`

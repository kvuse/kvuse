...
<script>
import {
  defineComponent, ref, onMounted, computed, watch, nextTick,
} from 'vue';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    // get endIndex
    const itemHeight = () => document.querySelector('.table-row')?.offsetHeight ?? document.querySelector('.list-item')?.offsetHeight ?? 10;
